...
ggplot(aes(y = average_mpg), data = CarPrice)+geom_boxplot() + labs(title = "Boxplot of average_mpg")
ggplot(aes(x = average_mpg), data = CarPrice)+geom_histogram() + labs(title = "Histogram of average_mpg")
```
