...
No, do not hire the dummy. Very misleading, fire right away. 
...
The skewness of the log transformation is approximately 1.27, which is close to the 1 for a normally distributed histogram. Compared to the higher skewness values for the original data and the boxcox transformation, this indicates that the log transformation does the best job at improving the skewness. 
